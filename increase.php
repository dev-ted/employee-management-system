      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <a href="#collapseCard" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCard">
            <h6 class="m-0 font-weight-bold text-primary">Salary Increase Request</h6>
          </a>
        </div>
        <div class="collapse show" id="collapseCard">
          ...
          <div class="card-body collapse show">
            ...
            <form action="increase.inc.php" method="post">
              <div class="form-row">
              ...
              <form action="" method="post">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <span>Reason</span>
                    <Textarea class="form-control" name="reason" rows="6" placeholder="Reason for request" required></Textarea>
                  </div>
